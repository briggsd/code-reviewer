...
1. **Preferred for general adopters:** an exact npm package version, installed with `bun add @briggsd/code-reviewer@0.4.0` (pin the version; drop the `@0.4.0` only to track latest).
